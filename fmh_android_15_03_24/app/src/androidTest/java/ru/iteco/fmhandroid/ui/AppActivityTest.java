...
public class AppActivityTest {
    ...
    public void appActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.news_item_title_text_view), withText("тест: wdvmk286sta"),
                        withParent(withParent(withId(R.id.news_item_material_card_view))),
                        isDisplayed()));
        textView.check(matches(withText("тест: wdvmk286sta")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.news_item_description_text_view), withText("Новость создана 22.03.2026 в 06:53"),
                        withParent(withParent(withId(R.id.news_item_material_card_view))),
                        isDisplayed()));
        textView2.check(matches(withText("Новость создана 22.03.2026 в 06:53")));
    }
